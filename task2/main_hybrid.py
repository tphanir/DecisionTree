...
# # 2. Bagged models (Bagging of unpruned trees)
# models_bagged = [
...
# # 3. Hybrid models (Bagging of PRUNED trees)
# models_hybrid = [
...
#     # Zip and loop through all three model types
#     for m_base, m_bagged, m_hybrid in zip(models_base, models_bagged, models_hybrid):
#         try:
...
#             # The name will be like "Entropy (Pruned) (Bagged)"
...
# print("\n=== Average Accuracy (Base vs. Bagged vs. Hybrid) Across All 10 Datasets ===")
# print(summary)
...
# df_results.to_csv("results/hybrid_10_datasets.csv", index=False)
# print("\nDetailed hybrid results saved to results/hybrid_10_datasets.csv")
